...
import cn.meteor.module.core.shiro.authc.SimpleAuthenticationInfo;
...
//              getName()  //realm name          
//      );
        SimpleAuthenticationInfo authenticationInfo = new SimpleAuthenticationInfo(user, credentialsFromStore.toCharArray(), realmName);
