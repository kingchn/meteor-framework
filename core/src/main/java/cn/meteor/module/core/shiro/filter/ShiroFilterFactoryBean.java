...
public class ShiroFilterFactoryBean implements FactoryBean, BeanPostProcessor {
    ...
    /**
     * add by shenjc 配置不需要过滤的url规则，需使用正则，多个之间已','分割
     */
...
//        return new SpringShiroFilter((WebSecurityManager) securityManager, chainResolver);
        return new SpringShiroFilter((WebSecurityManager) securityManager, chainResolver, this.excludeUrl);//modify by shenjc
    }
...
//        }
    	...
    	//modify by shenjc 
        protected SpringShiroFilter(WebSecurityManager webSecurityManager, FilterChainResolver resolver, String excludeUrl) {
            super();
