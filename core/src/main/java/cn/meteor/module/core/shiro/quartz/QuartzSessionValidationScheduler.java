package cn.meteor.module.core.shiro.quartz;
 ...
 * 基于Quartz 2.* 版本的实现
 * 
 * 在使用shiro时，如果Quartz 为Quartz 2的版本，则抛出异常java.lang.InstantiationError: org.quartz.SimpleTrigger。
 * 原因是默认的shiro-quartz1.2.3中的实现是针对quartz1.6版本的实现
 * （详细源码请查看org.apache.shiro.session.mgt.quartz.QuartzSessionValidationScheduler），
 * 在quartz2.2.1中，SimppleTrigger为接口，所以无法实例化。
 * 如果使用Quartz 2，则需要自定义Quartz 2的实现
 * 
 */  
