...
import cn.meteor.module.util.security.sm.SM2KeyExchangeUtil;
import cn.meteor.module.util.security.sm.SM2Utils;

import java.util.Arrays;

public class SM2KeyExchangeUtilsTest {
    ...
    public void testCaculateKey() {
        try {
            AsymmetricCipherKeyPair initiatorStaticKp = SM2Utils.generateKeyPairParameter();
            ...
            AsymmetricCipherKeyPair initiatorEphemeralKp = SM2Utils.generateKeyPairParameter();
            ...
            AsymmetricCipherKeyPair responderStaticKp = SM2Utils.generateKeyPairParameter();
            ...
            AsymmetricCipherKeyPair responderEphemeralKp = SM2Utils.generateKeyPairParameter();
