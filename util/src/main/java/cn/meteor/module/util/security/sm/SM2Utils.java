...
public class SM2Utils extends GMBaseUtils {
    //////////////////////////////////////////////////////////////////////////////////////
    /*
     * 以下为SM2推荐曲线参数
     */
    ...
    public static byte[] encrypt(String pubKeyX509DerBase64String, byte[] srcData) throws InvalidCipherTextException, NoSuchProviderException, NoSuchAlgorithmException, InvalidKeySpecException {
    	//公钥
    ...
    public static byte[] decrypt(String priKeyPkcs8DerBase64String, byte[] sm2Cipher) throws InvalidCipherTextException, NoSuchAlgorithmException, NoSuchProviderException, InvalidKeySpecException {
    	 //私钥
